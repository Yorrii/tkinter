...
class GUI:
    ...
    def create_button_frame(self):
        ...
        self.button2 = tk.Button(self.button_frame, text="Image", font=('Ariel', 24), width=15, height=3, 
                            background="#737270", relief="groove", activebackground='#b3b1af', command=self.Image)
        self.button3 = tk.Button(self.button_frame, text="Snake game", font=('Ariel', 24), width=15, height=3, 
                            background="#737270", relief="groove", activebackground='#b3b1af', command=self.Snake_Game)
    ...
    def Image(self):
        ...
        self.img_lable = tk.Label(master= self.image_window, image=self.images[self.image_counter])
