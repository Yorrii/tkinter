...
class Snake_Game():
    def __init__(self):
        ...
        self.speedEntry.insert(0, "200")    # Setting default text to be 200 inside of snake speed entry
        self.speedEntry.bind("<Button-1>", lambda e: self.speedEntry.delete(0, tk.END)) # binding snake speed entry to remove text inside if clicked
        ...
        self.widthEntry.bind("<Button-1>", lambda e: self.widthEntry.delete(0, tk.END))
        ...
        self.heightEntry.bind("<Button-1>", lambda e: self.heightEntry.delete(0, tk.END))
        ...
        #self.root.mainloop() # running the window


    def startGame(self): # příprava pro start hry
        self.speed = int(self.speedEntry.get())   # get text from entry widget
        self.width = int(self.widthEntry.get())   # get text from entry widget
        self.height = int(self.heightEntry.get()) # get text from entry widget
        self.square_size = 20
    ...
    def game_round(self): # hlavní metoda pro hru
        ...
        if self.check_for_collision():
            ...
            self.root.after(self.speed, self.game_round)
    ...
    def game_over(self):
        ...
        self.canvas.create_text(self.width*self.square_size/2, 
